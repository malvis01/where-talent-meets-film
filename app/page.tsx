  ...
  return (
    <main>
      <nav className="nav container">
        ...
        <a className="btn secondary" href="#join">Join Platform</a>
      </nav>
      ...
      <section className="hero container" id="top">
        <div>
          ...
          <div className="actions"><a className="btn primary" href="#join">Create Actor Profile →</a><a className="btn secondary" href="#production">Find Talent</a></div>
        </div>
      ...
      <section className="container" id="join"><div className="cta"><div><div className="eyebrow">Start your journey</div><h2>Where talent meets opportunity.</h2></div><div className="actions"><a className="btn primary" href="#">I&apos;m an Actor</a><a className="btn secondary" href="#">I&apos;m Production</a></div></div></section>
