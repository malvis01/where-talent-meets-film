    ...
    <main>
      ...
      <section className="hero container" id="top">
        <div>
          ...
          <div className="actions"><a className="btn primary" href="/actors/register">Create Actor Profile →</a><a className="btn secondary" href="#production">Find Talent</a><a className="btn secondary" href="/payments">Services & Payments</a></div>
        </div>
